...
namespace DiscussionBoard.Persistence.Migrations
{
    ...
    [Migration("20201027133434_FixedCommentVoteAddedPostVoteAddedUserSavedPost")]
    partial class FixedCommentVoteAddedPostVoteAddedUserSavedPost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscussionBoard.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DiscussionBoard.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
